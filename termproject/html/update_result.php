<?php 
    ...
    $sql =" UPDATE costomer SET costomer_id='".$costomer_id."', costomer_name='".$costomer_name."', 
    costomer_telephone='".$costomer_telephone."', costomer_home='".$costomer_home."'" WHERE costomer_id='".$costomer_id"'";
